...
train_dataset = TranslationDataset(src_sentences=df_train['la_tok'].values.tolist(),
                           tgt_sentences=df_train['en_tok'].values.tolist(),
                           src_vocab=la_vocab,
                           tgt_vocab=en_vocab)
...
train_dataloader = DataLoader(
    ...
    shuffle=True,
    collate_fn=trl_nn_collate_fn
)

val_dataset = TranslationDataset(src_sentences=df_val['la_tok'].values.tolist(),
                           tgt_sentences=df_val['en_tok'].values.tolist(),
                           src_vocab=la_vocab,
                           tgt_vocab=en_vocab)
...
la_tensor = batch_data['src']
en_tensor = batch_data['tgt']
